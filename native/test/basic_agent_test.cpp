...
public:
    ...
    bool wasOnAttachCalled() const { return on_attach_called_; }
};
...
TEST(BasicAgentTest, AgentModule_Initialize) {
    ...
    // Test null pointers
    EXPECT_EQ(module.initialize(nullptr, reinterpret_cast<jvmtiEnv*>(0x1), nullptr), 
              JVMTI_ERROR_NULL_POINTER);
    EXPECT_EQ(module.initialize(reinterpret_cast<JavaVM*>(0x1), nullptr, nullptr), 
              JVMTI_ERROR_NULL_POINTER);
    
    // Test valid pointers
    JavaVM fake_vm{};
    jvmtiEnv fake_jvmti{};
    EXPECT_EQ(module.initialize(&fake_vm, &fake_jvmti, nullptr), JVMTI_ERROR_NONE);
...
TEST(BasicAgentTest, AgentModule_OnAttach) {
    ...
    JavaVM fake_vm{};
    jvmtiEnv fake_jvmti{};
    module.initialize(&fake_vm, &fake_jvmti, nullptr);
